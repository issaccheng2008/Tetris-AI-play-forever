...
to see the AI play tetris yourself, first you will have to know the coordinate of the the top-left corner of the place where they show the next ![My Image](https://github.com/issaccheng2008/Tetris-AI-play-forever/blob/main/top_left_corner_of_piece.png)
